...
def startLogin():
        ...
        user=ttk.Entry(detailf)
        pwd=ttk.Entry(detailf,show="*")
        ...
        Button(b1f,text="Sign up",fg="dodger blue",bg="white",bd=0,activebackground="white",activeforeground="dodger blue",command=signup).pack(side=LEFT,pady=0,ipady=0)
        Button(b2f,text="Forgot your password?",fg="dodger blue",bg="white",bd=0,activebackground="white",activeforeground="dodger blue",command=forgetpwd).pack(pady=0,ipady=0)
